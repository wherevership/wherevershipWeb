...
<div class="clearfix"> 
  ...
  <div class="well col-xs-12 col-sm-4">
	<select class="form-control" id="OSSelect" name="OSSelect" onchange="orderlist.statussort('')">
		<option value=''>Filter By Status</option><option value='1' Selected>Unpaid (3)</option><option value='2' >Paid (0)</option><option value='3' >Partially Paid (0)</option>
	</select>
  </div>
...
<table id="myTable" class="table table-striped" width="100%">
  ...
  <tbody>
    ...
    <tr onmouseover="this.style.cursor='pointer'" class="listrow-6531600" data-id="6531600">
      <td class="hidden-xs"><input type='checkbox' disabled name='checkUsagedownloadno' id='awb6531600' onclick="checknow('6531600')" value="NjUzMTYwMA%3D%3D"></td>
      <td onclick="orderlist.Detail('6531600')">EI-IZ8JW <span class="visible-xs"> (Unpaid) 
         
        </span></td>
      <td class="hidden-xs"  onclick="orderlist.Detail('6531600')">2018-04-09 21:35:08</td>
      <td class="hidden-xs"  onclick="orderlist.Detail('6531600')">1</td>
      <td class="hidden-xs" >Unpaid 
        </td>
      <td class="hidden-xs" style="text-align:right"  onclick="orderlist.Detail('6531600')">7.80</td>
      <td class="visible-xs" onclick="orderlist.Detail('6531600')"> Date : 2018-04-09 21:35:08</br>
        Shipments : 1</br>
        Total Price : RM7.80 </br</td>
      <td class="action"><a class="pull-right mini"  data-id="6531600" style="padding-bottom:8px;margin-right:8px;font-size:20px;color: #959595;"  onclick="orderlist.Detail('6531600')"> <img src="https://secure.easyparcel.my/pass/application/source/Malaysia/img/detail-icon-new.png" title="Detail" width="20px" /> </a> 
        
         
        <a class="pull-right" style="padding-bottom:8px;margin-right:8px;font-size:20px;color: #959595;" dt-id="6531600" onclick="orderlist.Del(this)"> <img src="https://secure.easyparcel.my/pass/application/source/Malaysia/img/16px-delete.png" title="Cancel this order" width="20px" /> </a> 
    ...
    <tr onmouseover="this.style.cursor='pointer'" class="listrow-6477011" data-id="6477011">
      <td class="hidden-xs"><input type='checkbox' disabled name='checkUsagedownloadno' id='awb6477011' onclick="checknow('6477011')" value="NjQ3NzAxMQ%3D%3D"></td>
      <td onclick="orderlist.Detail('6477011')">EI-ITJ68 <span class="visible-xs"> (Unpaid) 
         
        </span></td>
      <td class="hidden-xs"  onclick="orderlist.Detail('6477011')">2018-04-05 11:43:28</td>
      <td class="hidden-xs"  onclick="orderlist.Detail('6477011')">1</td>
      <td class="hidden-xs" >Unpaid 
        </td>
      <td class="hidden-xs" style="text-align:right"  onclick="orderlist.Detail('6477011')">9.90</td>
      <td class="visible-xs" onclick="orderlist.Detail('6477011')"> Date : 2018-04-05 11:43:28</br>
        Shipments : 1</br>
        Total Price : RM9.90 </br</td>
      <td class="action"><a class="pull-right mini"  data-id="6477011" style="padding-bottom:8px;margin-right:8px;font-size:20px;color: #959595;"  onclick="orderlist.Detail('6477011')"> <img src="https://secure.easyparcel.my/pass/application/source/Malaysia/img/detail-icon-new.png" title="Detail" width="20px" /> </a> 
        
         
        <a class="pull-right" style="padding-bottom:8px;margin-right:8px;font-size:20px;color: #959595;" dt-id="6477011" onclick="orderlist.Del(this)"> <img src="https://secure.easyparcel.my/pass/application/source/Malaysia/img/16px-delete.png" title="Cancel this order" width="20px" /> </a> 
    ...
    <tr onmouseover="this.style.cursor='pointer'" class="listrow-6476269" data-id="6476269">
      <td class="hidden-xs"><input type='checkbox' disabled name='checkUsagedownloadno' id='awb6476269' onclick="checknow('6476269')" value="NjQ3NjI2OQ%3D%3D"></td>
      <td onclick="orderlist.Detail('6476269')">EI-ITJFP <span class="visible-xs"> (Unpaid) 
         
        </span></td>
      <td class="hidden-xs"  onclick="orderlist.Detail('6476269')">2018-04-05 11:23:44</td>
      <td class="hidden-xs"  onclick="orderlist.Detail('6476269')">1</td>
      <td class="hidden-xs" >Unpaid 
        </td>
      <td class="hidden-xs" style="text-align:right"  onclick="orderlist.Detail('6476269')">14.90</td>
      <td class="visible-xs" onclick="orderlist.Detail('6476269')"> Date : 2018-04-05 11:23:44</br>
        Shipments : 1</br>
        Total Price : RM14.90 </br</td>
      <td class="action"><a class="pull-right mini"  data-id="6476269" style="padding-bottom:8px;margin-right:8px;font-size:20px;color: #959595;"  onclick="orderlist.Detail('6476269')"> <img src="https://secure.easyparcel.my/pass/application/source/Malaysia/img/detail-icon-new.png" title="Detail" width="20px" /> </a> 
        
         
        <a class="pull-right" style="padding-bottom:8px;margin-right:8px;font-size:20px;color: #959595;" dt-id="6476269" onclick="orderlist.Del(this)"> <img src="https://secure.easyparcel.my/pass/application/source/Malaysia/img/16px-delete.png" title="Cancel this order" width="20px" /> </a> 
