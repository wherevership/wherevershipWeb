 <script>
	...
	$("#add_driver").addClass('active selected');
...
.profile-bg.bindCard_successful {
    ...
    <div class="container-fluid space-small">
      <h2 class="dashboard-title">Add New Driver</h2>
        ...
        <form method="post">
          ...
          <div class="col-md-6 col-xs-12 padding-off">
            ...
            <div class="col-md-12 col-sm-6 col-xs-12 form-group">
              ...
              <input required class="form-control required" type="text" name="txt_email" id="email" value="" placeholder="Email">
            </div>
            <div class="col-md-12 col-sm-6 col-xs-12 form-group">
